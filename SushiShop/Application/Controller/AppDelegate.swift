...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        Thread.sleep(forTimeInterval: 0.0) //Задержка Launching
    ...
    func customizeTabBar(){
        ...
        appearanceTabBar.backgroundColor = .black.withAlphaComponent(0.1)
        appearanceTabBar.backgroundEffect = UIBlurEffect(style: .dark)
    ...
    lazy var persistentContainer: NSPersistentContainer = {
         ...
         */
        let container = NSPersistentContainer(name: "SushiShop")
